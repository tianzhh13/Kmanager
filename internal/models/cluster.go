...
type Cluster struct {
	...
	JMXExporterURLs  string        `gorm:"column:jmx_exporter_url;type:text" json:"jmx_exporter_urls"`   // JMX Exporter HTTP 地址列表，逗号分隔（如 http://broker1:7071,http://broker2:7071）
